...
Progress: WP0, WP1, WP2, and WP3 are complete. The next implementation package is WP4.
...
| WP4 | DS-CWR estimator | Adjacent CWR, ISG, GLS, Q statistic | Matches Python on fixed seeds | Next |
| WP5 | Bootstrap inference | Multiplier bootstrap, bivariate Delta, Fieller | Coverage simulation reaches the predefined threshold | Pending |
